...
def assert_get_file_with_incorrect_file_id_response(actual: ValidationErrorResponseSchema):
    """
        Проверяет, что ответ на создание файла с неправильным форматом ID файла.
    ...
    expected = ValidationErrorResponseSchema(
        details=[
            ValidationErrorSchema(
                type="uuid_parsing",  # Тип ошибки, связанной с неправильным UUID.
                input="incorrect-file-id",  # Не корректный ID файла.
                context={
                    "error": "invalid character: expected an optional prefix of `urn:uuid:` "
                             "followed by [0-9a-fA-F-], found `i` at 1"
                },  # Не правильный формат UUID, найден не верный символ.
